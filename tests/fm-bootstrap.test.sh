...
codex-martos profile is accepted^{"rules":[{"when":"martos work","use":{"harness":"codex-martos","model":"gpt-5","effort":"xhigh"}}]}^empty^
unsupported codex-martos max effort is flagged^{"rules":[{"when":"martos work","use":{"harness":"codex-martos","effort":"max"}}]}^exact^CREW_DISPATCH: invalid config/crew-dispatch.json - invalid effort: codex-martos:max
