...
For an application task requiring a Lumbu schema change, use the cross-repository delivery contract in [`docs/architecture.md`](docs/architecture.md#cross-repository-application-delivery) and record its schema PR before application PR readiness or teardown.
