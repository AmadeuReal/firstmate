...
| `fm-snapshot.sh`         | Materialize and validate standalone portable Firstmate Git snapshots |
...
| `fm-nm-run.sh`           | Preflight, bound, and start or retry no-mistakes runs without duplicating active work |
