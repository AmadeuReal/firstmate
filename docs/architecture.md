...
That keeps spawn launch compatible across claude, codex, codex-personal, codex-martos, opencode, pi, pi-signed, grok, kimi, cursor, and muse while preserving the requested profile for later audit.
