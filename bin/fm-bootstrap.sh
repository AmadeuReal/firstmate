...
crew_dispatch_validate() {
  ...
  err=$(jq -r '
    def verified($h): ["claude","codex","codex-personal","codex-martos","opencode","pi","pi-signed","grok","kimi","cursor","muse"] | index($h);
    def effort_ok($h; $e):
      if $e == null then true
      elif ($e | type) != "string" then false
      elif $h == "claude" then (["low","medium","high","xhigh","max"] | index($e))
      elif $h == "codex" or $h == "codex-personal" or $h == "codex-martos" then (["low","medium","high","xhigh"] | index($e))
