...
#   /updatefirstmate, restart). A bare adapter name (claude|codex|codex-personal|opencode|pi|pi-signed|grok|kimi|
...
if [ "$RELAUNCH" -eq 1 ]; then
  ...
  case "${POS[1]:-}" in
    ''|claude|codex|codex-personal|opencode|pi|pi-signed|grok|kimi|muse)
      ARG3=${POS[1]:-}
      ;;
    *' '*)
